...
for i in range(1, 11):
    ...
    for month in range(1, 13):
        ...
        listings_data2=pd.merge(new_df, listings_data, how='left', left_on=['listing_id'], right_on=['id'],indicator=True)
        #print(listings_data2.columns)
        #print(listings_data2['listing_id'].values)
        listings_data[column_name]+=listings_data2['freq']
        listings_data[column_name]=listings_data[column_name].fillna(0)
